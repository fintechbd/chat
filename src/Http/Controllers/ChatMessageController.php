...
class ChatMessageController extends Controller
{
     ...
     * @lrd:end
     *
     * @param IndexChatMessageRequest $request
     ...
     *
     * @param string|int $id
     * @return ChatMessageResource|JsonResponse
    ...
    public function update(UpdateChatMessageRequest $request, string|int $id): JsonResponse
    {
        try {
            ...
            return $this->updated(__('core::messages.resource.updated', ['model' => 'Chat Message']));
    ...
    public function destroy(string|int $id)
    {
        try {
            ...
            return $this->deleted(__('core::messages.resource.deleted', ['model' => 'Chat Message']));
    ...
    public function restore(string|int $id)
    {
        try {
            ...
            return $this->restored(__('core::messages.resource.restored', ['model' => 'Chat Message']));
    ...
    public function export(IndexChatMessageRequest $request): JsonResponse
    {
        try {
            ...
            return $this->exported(__('core::messages.resource.exported', ['model' => 'Chat Message']));
     ...
     * @lrd:end
     *
     * @param ImportChatMessageRequest $request
     * @return ChatMessageCollection|JsonResponse
     */
